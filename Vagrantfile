...
#    end
  ...
  config.vm.define :vyatta_client2 do |vyatta_client2|
    ...
    vyatta_client2.vm.network "private_network", ip: "10.0.0.11"
...
#    end
  ...
  config.vm.define :vyatta_client3 do |vyatta_client3|
    ...
    vyatta_client3.vm.network "private_network", ip: "10.0.2.2"
    vyatta_client3.vm.network "private_network", ip: "10.0.1.3"
...
#    end
  ...
  config.vm.define :vyatta_client4 do |vyatta_client4|
    ...
    vyatta_client4.vm.network "private_network", ip: "10.0.0.2"
    vyatta_client4.vm.network "private_network", ip: "10.0.1.2"
    vyatta_client4.vm.network "private_network", ip: "192.168.2.11"
